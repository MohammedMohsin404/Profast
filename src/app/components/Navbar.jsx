  ...
  return (
    <div className="navbar bg-white shadow-sm rounded-2xl py-5">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          >
           ...
           <Link href="/signin" className="btn btn-outline rounded-xl text-xl px-8 py-4 border-[#DADADA] min-h-[56]"> Sign In</Link>
      <div className="flex">
      ...
      <div className="navbar-end space-x-4 hidden md:flex">
        <Link href="/signin" className="btn btn-sm rounded-xl text-xl px-8 py-4 border-[#DADADA] min-h-[56] hover:bg-[#CAEB66] "> Sign In</Link>
